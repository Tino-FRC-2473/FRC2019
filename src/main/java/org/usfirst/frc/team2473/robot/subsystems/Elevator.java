...
public class Elevator extends Subsystem {
    ...
    public enum ElevatorPosition {
        ...
        ZERO(0), RELEASE_CARGO_MECH(7), CARGO_LOW(9.4), CARGO_MID(105.6), CARGO_HIGH(198), CARGO_PICKUP(111), CARGO_GROUND(0), HATCH_LOW(24.4), HATCH_MID(125.6), HATCH_HIGH(204), HATCH_PICKUP(7);
